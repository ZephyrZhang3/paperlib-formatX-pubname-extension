# Paperlib FormatX Publication Name Extension

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

A Paperlib extension that automatically formats publication names when importing papers into your library.
...
Forked from [Future-Scholars/paperlib-format-pubname-extension](https://github.com/Future-Scholars/paperlib-format-pubname-extension).
